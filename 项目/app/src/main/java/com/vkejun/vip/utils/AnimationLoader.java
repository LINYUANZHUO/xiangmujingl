...
public class AnimationLoader {
    public static AnimationSet getInAnimation(Context paramContext) {
        ...
        ScaleAnimation scaleAnimation1 = new ScaleAnimation(1.05F, 0.95F, 1.05F, 0.95F, 1, 0.5F, 1, 0.5F);
        scaleAnimation1.setDuration(105L);
        scaleAnimation1.setStartOffset(135L);
